...
C {lab_wire.sym} 1030 -280 0 0 {name=p6 sig_type=std_logic lab=B1}
C {lab_wire.sym} 910 -280 0 0 {name=p7 sig_type=std_logic lab=A1}
C {lab_wire.sym} 1150 -280 0 0 {name=p8 sig_type=std_logic lab=C1}
C {lab_wire.sym} 1090 -280 0 0 {name=p9 sig_type=std_logic lab=B2}
C {lab_wire.sym} 970 -280 0 0 {name=p10 sig_type=std_logic lab=A2}
...
"}
C {devices/code_shown.sym} 70 -1790 0 0 {name=NGSPICE1 only_toplevel=true
value="
.control
save all
** Define input signal
